...
ACCOUNT_TO_CLIENT = {
    ...
    '200000010006080174447': 'علي سعود',   # علي سعود عبدالله بن عسكر - client   # مؤسسة مهجة التجارية
    '12900608016890598': 'ريميندر',        # same client (shorter format seen in PDF)
...
ACCOUNT_CATEGORY = {
    ...
    '200000010006080174447': 'client_payment',  # علي سعود
